...
class WarmupScheduler(_LRScheduler):
    ...
    def __init__(self, optimizer, warmup_iters, warmup_ratio = 0.1, warmup_mode = 'linear', last_epoch = -1, verbose = False):
        # validate the "warmup" argument
        assert warmup_mode is not None and warmup_mode in ['constant', 'linear', 'exp'], \
