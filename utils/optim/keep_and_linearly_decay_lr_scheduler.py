...
class KeepAndLinearlyDecayLrScheduler(_LRScheduler):
    ...
    def __init__(self, optimizer, keep_epochs, decay_epochs, last_epoch = -1, verbose = False):
    ...
    def get_lr(self):
        ...
        return [base_lr * max(0, 1 - (self.last_epoch + 1 - self.keep_epochs) / self.decay_epochs) for base_lr in self.base_lrs]
