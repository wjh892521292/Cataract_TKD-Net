...
class InceptionA(BaseModule):
    ...
    def __init__(
        ...
        super().__init__(init_cfg=init_cfg)
        self.branch1x1 = BasicConv2d(in_channels, 64, kernel_size=1, conv_cfg=conv_cfg)
        ...
        self.branch_pool_downsample = nn.AvgPool2d(kernel_size=3, stride=1, padding=1)
...
class InceptionC(BaseModule):
    ...
    def __init__(
        ...
        super().__init__(init_cfg=init_cfg)
        self.branch1x1 = BasicConv2d(in_channels, 192, kernel_size=1, conv_cfg=conv_cfg)
...
class InceptionE(BaseModule):
    ...
    def __init__(
        self, in_channels: int, conv_cfg: Optional[dict] = None, init_cfg=None
    ):
        super().__init__(init_cfg=init_cfg)
        self.branch1x1 = BasicConv2d(in_channels, 320, kernel_size=1, conv_cfg=conv_cfg)
...
class InceptionAux(BaseModule):
    ...
    def __init__(
        ...
        self.conv0 = BasicConv2d(in_channels, 128, kernel_size=1, conv_cfg=conv_cfg)
